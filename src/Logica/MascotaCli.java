...
@Entity
public class MascotaCli implements Serializable {
    @Id
    ...
    public MascotaCli(int num_cliente, String nombre_perro, String raza, String color, String alergico, String atencion_especial, String nombre_duenio, int celular_duenio, String observaciones) {
